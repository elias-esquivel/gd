...
$this->sections[] = array(
	...
	'fields' => array(
            ...
            array(
                ...
                'type'     => 'color',
                'title'    => '<div class="color-box" style="background-color:#000000"></div>'.__( 'Menu Icon Background', 'H-Code' ),
                'default'  => '#000000',
                'output' => array('background' => '.navbar-default .navbar-toggle'),
            ),
            array(
                'id'       => 'mobile-menu-icon-color',
                'type'     => 'color',
                'title'    => '<div class="color-box" style="background-color:#ffffff"></div>'.__( 'Menu Icon Color', 'H-Code' ),
                'default'  => '#ffffff',
                'output' => array('background' => '.navbar-default .navbar-toggle .icon-bar'),
            ),
            array(
                'id'        => 'opt-accordion-begin-menu-color',
                'type'      => 'accordion',
